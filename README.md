...
Fraud investigation queues and dispositions

GL Summary

Fraud losses, recoveries, and net loss by date and LOB

Rules & Alerts

Simulated fraud detection signals
...
Power BI (mockups) / Tableau-ready outputs

Excel & PowerPoint (executive-style deliverables)
